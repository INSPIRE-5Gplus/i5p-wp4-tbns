    ...
    std::map<string, string> clli = {
            ...
            std::map<string, std::vector<client_portinfo>> node_clientports = {
                {"1", {
                          ...
                          {15, 1.232718, 41.105505, CS_6_25GHZ, std::nullopt, std::nullopt}, // D4-D2_B
                          {15, 1.232718, 41.105505, CS_6_25GHZ, std::nullopt, std::nullopt}, // D4-D2_C
                          {15, 1.232718, 41.105505, CS_6_25GHZ, std::nullopt, std::nullopt}, // D4-D2_D
                          {15, 1.232718, 41.105505, CS_6_25GHZ, std::nullopt, std::nullopt} // D4-D2_E
                      }
                },
                {"2", {
            ...
            uuid = pce::generate_name_uuid("D4-context");
            g.properties["context-uuid"] = to_string(uuid);
            uuid = pce::generate_name_uuid("D4-graph");
